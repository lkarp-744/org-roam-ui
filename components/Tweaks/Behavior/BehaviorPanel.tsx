    ...
    >
      <Flex alignItems="center" justifyContent="space-between">
        ...
        <Menu isLazy placement="right">
          ...
          >
            <Text>
              {mouse.preview
                ? mouse.preview[0]!.toUpperCase() + mouse.preview!.slice(1)
                : 'Never'}
            </Text>
          </MenuButton>
          <Portal>
            ...
            <MenuList bgColor="gray.200" zIndex="popover">
              <MenuItem onClick={() => setMouse({ ...mouse, preview: '' })}>
                Never
              </MenuItem>
              <MenuItem
                onClick={() => setMouse({ ...mouse, preview: 'click' })}
              >
                Click
              </MenuItem>
              <MenuItem
                onClick={() => setMouse({ ...mouse, preview: 'double' })}
              >
                Double Click
              </MenuItem>
            </MenuList>
        ...
        <Menu isLazy placement="right">
          ...
          <Portal>
            ...
            <MenuList bgColor="gray.200" zIndex="popover">
              ...
              <MenuItem
                onClick={() => setMouse({ ...mouse, follow: 'double' })}
              >
                Double Click
              </MenuItem>
      ...
      <Flex alignItems="center" justifyContent="space-between">
        ...
        <Menu isLazy placement="right">
          ...
          >
            <Text>
              {behavior.follow[0].toUpperCase() + behavior.follow.slice(1)}
            </Text>
          </MenuButton>
          <Portal>
            {' '}
            <MenuList bgColor="gray.200" zIndex="popover">
              <MenuItem
                onClick={() => setBehavior({ ...behavior, follow: 'color' })}
              >
                Just coloring the currently opened node
              </MenuItem>
              <MenuItem
                onClick={() => setBehavior({ ...behavior, follow: 'local' })}
              >
                Opening the local graph
              </MenuItem>
              <MenuItem
                onClick={() => setBehavior({ ...behavior, follow: 'zoom' })}
              >
        ...
        <Menu isLazy placement="right">
          ...
          <Portal>
            ...
            <MenuList bgColor="gray.200" zIndex="popover">
              <MenuItem
                onClick={() =>
                  setBehavior({ ...behavior, localSame: 'replace' })
                }
              >
